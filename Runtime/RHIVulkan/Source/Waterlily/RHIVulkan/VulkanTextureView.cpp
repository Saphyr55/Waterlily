...
namespace Wl
{
    ...
    void VulkanTextureView::Create(const RHITextureViewDescription& description, VkImageView imageView)
    {
        m_handle = imageView;
        Create(description);
    }
    ...
    void VulkanTextureView::Create(const RHITextureViewDescription& description)
    {
        ...
        VkImageViewType imageType = VK_IMAGE_VIEW_TYPE_MAX_ENUM;
        switch (m_description.Dimension)
        {
            ...
            case RHITextureDimension::Dim1D:
                imageType = VK_IMAGE_VIEW_TYPE_1D;
                break;
            default:
                imageType = VK_IMAGE_VIEW_TYPE_MAX_ENUM;
                break;
        }
        ...
        image_view_create_info.viewType = imageType;
